          ...
          [
                    {
                              ...
                              anchorUrl:'https://i.pinimg.com/originals/38/4e/ea/384eeab653017b3ce0f3623b3f549c51.jpg',
...
function changeFont(elmt)
{
          let size = elmt.getAttribute('id')
          
          let ss = document.getElementsByTagName('body')
          
          if (size=='lgFontButton') 
          {
                    
                 
                   
                    root.style.setProperty('--fontSize','1.5rem')
                    sessionStorage.setItem('fontSize','lg') 
                 
          }
          else if (size=='mdFontButton')
          {
                    root.style.setProperty('--fontSize','1.2rem')
                    sessionStorage.setItem('fontSize','md')
          }
          else     
          {
                  
                    root.style.setProperty('--fontSize','1.0rem')
                    sessionStorage.setItem('fontSize','sm')
          }
}
var root = document.documentElement
function check_font_size()
{
          let savedSize = sessionStorage.fontSize
         
          
          if(savedSize =='lg')
          {
                    // bodyTag.className='globalLgFont'
                    root.style.setProperty('--fontSize',"1.5rem;")
                    console.log('lg')
                    return
          }
...
document.addEventListener('DOMContentLoaded',check_font_size(),false)
