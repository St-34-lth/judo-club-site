          ...
          [
                    {
                              ...
                              carouselItemSecond:'../assets/images/judo-rei-drawing-blondia-bert.jpg',
                              carouselItemThird:'',
                    }
          ],
          mainList:[
                    {
                              mainListItem:"<video height='85%;' width='60%;'src='../assets/0-02-0a-975b369384235524651a89e42c1e4add3bed4d33f346a3bbfdbb758d6acf8bf4_3efb72baecf22c51.mp4' controls></video>"
                            
                    },
                    {
                              mainListItem:'<iframe width="600px;" height="100%;" src="https://www.youtube.com/embed/Zy7bRVk5hP0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    },
                    {
                              mainListItem:'<iframe width="600px" height="85%" src="https://www.youtube.com/embed/2DQ1lTR1B8Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'
                    }
...
function form_validation()
{
  ...
  // Loop over element selection array and submit action
